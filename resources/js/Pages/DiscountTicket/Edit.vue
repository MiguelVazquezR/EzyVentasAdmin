<template>
    <AppLayout title="Editar cupón de descuento">
        <main class="px-10 py-7">
            ...
            <form @submit.prevent="update"
                ...
                <h1 class="font-bold ml-2 col-span-full">Editar cupón de descuento</h1>
...
data() {
    const form = useForm({
        code: this.discount_ticket.code,
        is_percentage_discount: !! this.discount_ticket.is_percentage_discount,
        discount_amount: this.discount_ticket.discount_amount,
        is_active: !! this.discount_ticket.is_active,
        expired_date: this.discount_ticket.expired_date,
    });
...
props:{
    discount_ticket: Object
},
methods:{
    update() {
        this.form.put(route("discount-tickets.update", this.discount_ticket.id), {
            onSuccess: () => {
                this.$notify({
                    title: "Correcto",
                    message: "",
